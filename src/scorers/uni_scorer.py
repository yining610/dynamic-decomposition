...
Heavily adapted from https://github.com/zipJiang/Core/blob/main/src/core/scorers/unli_confidence_boost_scorer.py"""

from typing import Text, Dict, List, Union, Optional
from dataclasses import dataclass
import numpy as np
from ..entailers.entailer import Entailer, EntailerInstance
from .scorer import Scorer, ScorerInstance
...
class UNLIConfidenceBoostScorer(Scorer):
    ...
    def _batch_score(
        self, instances: List[ScorerInstance], silent: bool = True
