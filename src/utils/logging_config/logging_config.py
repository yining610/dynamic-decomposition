...
from src.utils.logging_config.color_formatter import ColoredFormatter

def setup_logging(default_path: str = 'src/utils/logging_config/logging_config.json', default_level: int = logging.INFO) -> None:
    """
