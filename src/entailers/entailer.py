...
Heavily adapted from https://github.com/zipJiang/Core/blob/main/src/core/entailers/entailer.py"""
...
from src.utils.utils import paginate_func, MODEL_CACHE_DIR
from .caching import EntailmentCache
...
class Entailer:
    ...
    def _load_model(self):
        ...
        self._tokenizer = AutoTokenizer.from_pretrained(self._model_name, cache_dir=MODEL_CACHE_DIR)
